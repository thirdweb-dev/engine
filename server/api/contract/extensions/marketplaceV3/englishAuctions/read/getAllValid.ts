...
// LOGIC
export async function eaGetAllValid(fastify: FastifyInstance) {
  fastify.route<{
    ...
    method: "GET",
    url: "/marketplace/v3/:chain_name_or_id/:contract_address/englishAuction/getAllValid",
    schema: {
      description: "Get all the valid auction listings on the marketplace.",
      tags: ["MarketplaceV3-EnglishAuction"],
      operationId: "mktpv3_eaGetAllValid",
