...
// LOGIC
export async function dlRevokeCurrencyApprovalForListing(
  ...
  fastify.route<{
    ...
    method: "POST",
    url: "/marketplace/v3/:chain_name_or_id/:contract_address/directListing/revokeCurrencyApprovalForListing",
    schema: {
      description:
