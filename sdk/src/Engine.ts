...
class EngineLogic {
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
        ...
        this.marketplaceDirectListings = new MarketplaceDirectListingsService(this.request);
        this.marketplaceEnglishAuctions = new MarketplaceEnglishAuctionsService(this.request);
