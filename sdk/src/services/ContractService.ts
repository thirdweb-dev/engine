...
export class ContractService {
  ...
  public write(
    ...
    requestBody: {
      /**
       * The function to call on the contract. It is highly recommended to provide a full function signature, such as
       * "function mintTo(address to, uint256 amount)", to avoid ambiguity and to skip ABI resolution.
       */
      functionName: string;
      /**
       * An array of arguments to provide the function. Supports: numbers, strings, arrays, objects. Do not provide:
       * BigNumber, bigint, Date objects
       */
      args: Array<any>;
      txOverrides?: {
        /**
