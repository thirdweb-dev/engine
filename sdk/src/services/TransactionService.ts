...
export class TransactionService {
   ...
   * @throws ApiError
   */
  public status(queueId: string): CancelablePromise<{
    result: {
      queueId: string | null;
      /**
       * The current state of the transaction.
   ...
   * @throws ApiError
   */
  public retryFailed(requestBody: {
    /**
     * Transaction queue ID
     */
    queueId: string;
  ...
  /**
   * Cancel transaction
   * Attempt to cancel a transaction by sending a null transaction with a higher gas setting. This transaction is not
   * guaranteed to be cancelled.
   * @param requestBody
   * @returns any Default Response
   * @throws ApiError
   */
  public cancel(requestBody: {
    /**
     * Transaction queue ID
     */
    queueId: string;
   ...
   * Get transaction logs for a mined transaction. A tranasction queue ID or hash must be provided. Set `parseLogs` to
