...
export class ConfigurationService {
   ...
   * @throws ApiError
   */
  public updateChainsConfiguration(requestBody: {
   ...
   * @throws ApiError
   */
  public updateTransactionConfiguration(requestBody?: {
    maxTxsToProcess?: number;
    maxTxsToUpdate?: number;
    minedTxListenerCronSchedule?: string | null;
    retryTxListenerCronSchedule?: string | null;
   ...
   * @throws ApiError
   */
  public updateAuthConfiguration(requestBody: {
    domain: string;
  }): CancelablePromise<{
    result: {
      domain: string;
   ...
   * @throws ApiError
   */
  public updateBackendWalletBalanceConfiguration(requestBody?: {
    /**
     * Minimum wallet balance in wei
     */
    minWalletBalance?: string;
   ...
   * @throws ApiError
   */
  public addUrlToCorsConfiguration(requestBody: {
   ...
   * @throws ApiError
   */
  public removeUrlToCorsConfiguration(requestBody: {
   ...
   * @throws ApiError
   */
  public setUrlsToCorsConfiguration(requestBody: {
    urls: Array<string>;
  }): CancelablePromise<{
    result: Array<string>;
  }> {
   ...
   * @throws ApiError
   */
  public updateCacheConfiguration(requestBody: {
    /**
     * Cron expression for clearing cache. It should be in the format of 'ss mm hh * * *' where ss is seconds, mm is
     * minutes and hh is hours. Seconds should not be '*' or less than 10
     */
    clearCacheCronSchedule: string;
  }): CancelablePromise<{
    result: {
   ...
   * @throws ApiError
   */
  public updateContractSubscriptionsConfiguration(requestBody?: {
    maxBlocksToIndex?: number;
    /**
     * Requery after one or more delays. Use comma-separated positive integers. Example: "2,10" means requery after
     * 2s and 10s.
     */
    contractSubscriptionsRequeryDelaySeconds?: string;
  }): CancelablePromise<{
   ...
   * @throws ApiError
   */
  public setIpAllowlist(requestBody: {
    /**
