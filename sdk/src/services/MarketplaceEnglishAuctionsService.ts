...
export class MarketplaceEnglishAuctionsService {
  ...
  public getAllEnglishAuctions(
    ...
    result: Array<{
      ...
      /**
       * The quantity of tokens to include in the listing. NOTE: For ERC721s, this value should always be 1 (and will
       * be forced internally regardless of what is passed here).
       */
      quantity?: string;
      /**
       * The listing ID.
   ...
   * Cancel an existing auction listing. Only the creator of the listing can cancel it. Auctions cannot be canceled
  ...
  public createEnglishAuction(
    ...
    requestBody: {
      ...
      bidBufferBps?: string;
      /**
       * time in seconds that are added to the end time when a bid is placed (default is contract-level time buffer in
       * seconds)
       */
  ...
  public makeEnglishAuctionBid(
    ...
    requestBody: {
      ...
      listingId: string;
      /**
       * The amount of the bid to place in the currency of the listing. Use getNextBidAmount to get the minimum amount
       * for the next bid.
       */
      bidAmount: string;
    },
