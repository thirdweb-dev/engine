...
export class ContractSubscriptionsService {
   ...
   * @throws ApiError
   */
  public addContractSubscription(requestBody: {
    /**
    ...
    processTransactionReceipts: boolean;
    /**
     * A case-sensitive list of function names to filter transaction receipts. Parses all transaction receipts by
     * default.
     */
    filterFunctions?: Array<string>;
  }): CancelablePromise<{
   ...
   * @throws ApiError
   */
  public removeContractSubscription(requestBody: {
    /**
   ...
   * @throws ApiError
   */
  public getLatestBlock(chain: string): CancelablePromise<{
    result: {
      lastBlock: number;
      status: string;
    };
