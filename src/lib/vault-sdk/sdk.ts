...
// --- Constants ---
export const SIGNED_TOKEN_PREFIX = "vt_sat_";
export const STORED_TOKEN_PREFIX = "vt_act_";
 ...
 *
 * NOTE: This function is ASYNCHRONOUS because JWT signing using Web Crypto is async. It does not make any network calls to the Vault service.
 *
